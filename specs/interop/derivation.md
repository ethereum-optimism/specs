...
On the first block at or after the [activation block](#activation-block), where the current chain is in a
...
implementation slot to point to the CrossL2Inbox deployment deployed at the activation block.
